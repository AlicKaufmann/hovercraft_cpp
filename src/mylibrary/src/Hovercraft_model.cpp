...
Hovercraft_model::Hovercraft_model()
{
	...
	vector<double> uT = {-1.5340, -1.3959, -1.1630, -1.022, -0.7839, -0.36309, -0.3850, -0.2244, 0, 0.2244, 0.3850, 0.6309, 0.7839, 1.022, 1.1630, 1.3959, 1.5340};
	...
	vector<DM> input = {DM::eye(1)};
	vector<double> output;
	cout << "blablblablaa" << endl;
	...
	MX y = MX::vertcat({px, py, theta, omega});
        ...
        Function f = Function("f", {states, u, t},{rhs},{"x","u","t"},{"rhs"}); // fonction of the dynamics
        Function h = Function("h", {states},{y}); // measurment function
}
